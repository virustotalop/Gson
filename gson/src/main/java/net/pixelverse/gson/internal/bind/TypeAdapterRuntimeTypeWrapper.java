...
final class TypeAdapterRuntimeTypeWrapper<T> extends net.pixelverse.gson.TypeAdapter<T> {
  ...
  public void write(JsonWriter out, T value, boolean includeType) throws IOException {
    ...
    net.pixelverse.gson.TypeAdapter chosen = delegate;
    Type runtimeType = getRuntimeTypeIfMoreSpecific(type, value);
    if (runtimeType != type) {
      net.pixelverse.gson.TypeAdapter runtimeTypeAdapter = context.getAdapter(TypeToken.get(runtimeType));
